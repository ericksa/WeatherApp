...
public class WeatherAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View v, ViewGroup vg) {
        ...
        if (v == null) {
            ...
            v = LayoutInflater.from(context).inflate(R.layout.activity_main, null);
            ...
            v.setTag(vh);
            vh.editText = (TextView) v.findViewById(R.id.resultTextView);
            v.setTag(vh);
            vh.button = (TextView) v.findViewById(R.id.button);
            v.setTag(vh);
        ...
        vh.temperature.setText(res.getTemperatureInFahrenheit() + "°F");
